...
class ProgressTests(unittest.TestCase):
    ...
    def test_repeated_catalog_activity_requires_a_new_record_id(self):
        ...
        with self.assertRaises(ProgressError) as error:
            complete_activity(updated, "E001", "EV001", "REPEAT_1", self.today)
    ...
    def test_failures_do_not_change_the_input(self):
        ...
        cases = [
            ...
            ("E001", "EV026", "NEW", "event_inactive"),
            ("E002", "EV001", "NEW", "role_mismatch"),
            ("E001", "EV001", self.dataset.activity_history[0].record_id, "duplicate_record"),
        ]
