...
const btnVariants: Record<BtnVariant, string> = {
  primary: 'bg-brand-600 text-white shadow-[0_6px_20px_-6px_rgba(0,129,95,0.55)] hover:bg-[#006f52] disabled:bg-brand-600/50 disabled:shadow-none',
    ...
    <div className={cn('h-2 w-full overflow-hidden rounded-full bg-black/[0.06]', className)}>
      <div
        className={cn(
          ...
          tone === 'green' ? 'bg-gradient-to-r from-[#ffc629] to-[#f1a400]' : 'bg-gradient-to-r from-[#1fae7a] to-[#00815f]',
        )}
